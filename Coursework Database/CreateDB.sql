...
CREATE TABLE Triangles (
	...
	CONSTRAINT Triangles_FK FOREIGN KEY (Vertex1ID) REFERENCES Vertices(VertexID),
	CONSTRAINT Triangles_FK FOREIGN KEY (Vertex2ID) REFERENCES Vertices(VertexID),
	CONSTRAINT Triangles_FK FOREIGN KEY (Vertex3ID) REFERENCES Vertices(VertexID)
);
